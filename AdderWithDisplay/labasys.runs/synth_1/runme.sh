...
HD_PWD='C:/Users/dhako/Desktop/FPGA/Ex_Files_FPGA_Development/Exercise Files/Vivado/AdderWithDisplay/labasys.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AdderWithDisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AdderWithDisplay.tcl
